...
export class ProfitabilitySnapshotAdapter {
  public build(
    ...
    const metrics = context.registry.getMetrics("Profitability");
    const thresholds = context.registry.getThresholds("Profitability");
    const statuses = context.registry.getStatuses("Profitability");
    const narratives = context.registry.getNarratives("Profitability");
